...
```
┌──────────────────┐  ┌──────────────────┐  ┌──────────────────────┐  ┌──────────────────┐  ┌──────────────────┐  ┌──────────────────┐
│  1. INGESTION    │  │  2. CHUNKING     │  │  3. EMBEDDING +      │  │  4. RETRIEVAL    │  │  5. GENERATION   │  │  6. INTERFACE    │
│                  │─▶│                  │─▶│     VECTOR STORE     │─▶│                  │─▶│                  │─▶│                  │
│  pdfplumber      │  │  Fixed-size      │  │  all-MiniLM-L6-v2    │  │  cosine sim      │  │  Groq API        │  │  Gradio          │
│  csv module      │  │  (CSV, grouped   │  │  sentence-           │  │  top-k = 7       │  │  llama-3.3-70b   │  │  preset Q        │
│                  │  │   by retire date)│  │  transformers        │  │                  │  │  -versatile      │  │  dropdown        │
│                  │  │  Semantic        │  │  ChromaDB            │  │                  │  │                  │  │  + source        │
│                  │  │  (FAQ, Reddit)   │  │                      │  │                  │  │                  │  │  attribution     │
│                  │  │  Recursive       │  │                      │  │                  │  │                  │  │                  │
│                  │  │  (articles)      │  │                      │  │                  │  │                  │  │                  │
└──────────────────┘  └──────────────────┘  └──────────────────────┘  └──────────────────┘  └──────────────────┘  └──────────────────┘
```
